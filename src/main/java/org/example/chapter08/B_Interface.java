...
// - 모든 매서드는 추상 메서드: public abstract 특성을 가짐
// - 모든 필드는 상수: public static final 특성을 가짐

// cf) >> (프로그램 전반의) 규칙(규약)
//      : 실제 구현은 인터페이스를 구현한 글래스에서 담당
...
interface PlayingCard {
    ...
    // 1. 필드 (멤버 변수): 상수 선언
    // : public static final 특성츨 가짐 (생략 가능)
    ...
    // >> 인터페이스와 관련되 공통 동작(유틸리티) 메서드를 제공하기 위해 사용
...
class Card implements PlayingCard  {
    ...
    public void defaultMethod() {
        System.out.println("Car 클래스에서 재정의 된 디폴트 메서드");
