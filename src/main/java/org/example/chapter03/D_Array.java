...
// cf) Array 클래스
//      : 배열을 조작하는 데 유용한 기능들으 제공해주는' 자바 내부 클래스'
//      : java.util 내에 존재
//      >> 정렬, 검색, 변환 등
public class D_Array {
    public static void main(String[] args) {
         // == Array  클래스 사용 법 == //
        // : 자바의 Array(배열) 자료형만 동작
        //      >> 일반 배열만 사용
        // cf) 동적 배열(ArrayList, List)는 사용 불가! - Collections 클래스 사용
        ...
        // - 배열 내에 존재 0: 존재하는 요소의 인덱스 번호를 변환
        ...
        // cf) binarySearch()는 반드시 졍렬된 배여 내에서 검색
        // : 해당 기능이 '이진 탐색 알고리즘' 을 사용하기 때문

        // 4. 배열의 비교: Arrays.equals(a배열, b배열)
