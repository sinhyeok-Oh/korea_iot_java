...
/*
    ...
    - 체크(컴파일) 예외: 필수 명시 / 언체크(런타입) 예외: 선택명시

    [사용법]
    :[ 접근제어자] 반환타입 메서드명() throws ExceptionType {}

    cf) throw: 메서드 내부에 위치, 예외를 발생시킴, throw new ExceptionType("예외 메서지");
 */
