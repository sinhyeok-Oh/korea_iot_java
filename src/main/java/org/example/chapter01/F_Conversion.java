...
public class F_Conversion {
    // main 메소드 ; 파일 단위의 실행을 담당하는 도구
    // - main + (ctrl + space)
    public static void main(String[] args) {
        /*
            === 자바의 형변환(Type Conversion)===
       ...
       // char f = e; - 묵시적 형 변환 불가 (char 는 2byte)
        ...
        // - 유니코드 이전은 각 국가애서 나라별 문자 인코딩 방식 사용 ( 영어: 아스키, 한국어: EUC-KR)
        // - 웹에서는 주로 UTF-8 이라는 유니코드 형식을 사용
        // - 이모지까지 코드값으로 변환 가능
        // EX) 문자마다 교유한 숫자(코드)가 정해져 있음: 'A' == 65

        // 1) char(문자)를 숫자로 변환
        // : 문자의 유니코드 값으로 변환
        char latter= 'A';
        int unicodeLetter = latter;
