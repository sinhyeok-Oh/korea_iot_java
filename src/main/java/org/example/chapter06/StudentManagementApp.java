...
public class StudentManagementApp {
    ...
    //      - main 메서드 내부에서 다른 메서드 호출 시 반드시 해당 메서드는 static 이어야 한다
    ...
    // > JVM은 main 매서드가 없을 경우 해당 파일을 실행 x
    public static void main(String[] args) {

        // 학생 추가
        addStudent(1, "김보미", 20, " Iot", 3.8);
        addStudent(2, "박진영", 22, " Iot", 3.9);
        addStudent(3, "오신혁", 21, " Iot", 3.7);
