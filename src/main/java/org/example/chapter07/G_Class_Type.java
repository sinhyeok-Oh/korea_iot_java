...
public class G_Class_Type {
    ...
    public static void main(String[] args) {
       ...
       // childObject.childMethod();
        ...
        // 2. 강제 다입 변환(다운캐스팅, DownCasting)
        // : ' 부모 클래스 타입으로 변한된 객체를' 다시! 자식 클래스 타입으로 벼환하는 것
        // - 자식 클래스에만 정의된 맴버에 다시 접근 가능

        // 자식 타입 객체 변수명 = (자식타입) 부모객체;
