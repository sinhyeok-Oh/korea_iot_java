...
//      >> 데이터에 접근하거나 수정할 때는 getter & setter 메서드를 사용하느 체게
...
class Student {
    ...
    // cf) getter 는 단순한 데이터의 반환 뿐망 아니라, 데이터 가공 역할을 담당하기도 함
    ...
    // cf) setter 단순한 데이터 설정 뿐만 아니라, 데이터의 검증 역랗을 담담하기도 함
    ...
    public class B_Encapsulation {
        public static void main(String[] args) {
            ...
            student.setAge(-30);
            student.setAge(29);
            student.setResidentNumber(142536);
            student.setScore(10);
            student.setScore(100);

            student.setResidentNumber(848213);
