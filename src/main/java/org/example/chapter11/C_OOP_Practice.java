 ...
 * OCP : 개방 페쇄 원칙 - 확장에 개방, 수정에 패쇄
 * LSP : 리스코프 치환 원칙 - 자식 클래스는 부모 클래스를 대테 할 수 있음 (부모와 행위의 일관성)
 * ISP : 인터페이스 분리 원칙 - 자신의 사용하지 않는 인터페이스에 의존하지 X
 * DIP : 의존 역전 원칙 - 클래스 간의 결합을 낮추고, 추상화에 의존해야 한다
 * */

// == SOLID 원칙을 활용한 주무 관리 시스템 == //
...
public class C_OOP_Practice {
    public static void main(String[] args) {
        ...
        Order order2 = new Order("2", 23000);
