...
* - null 값을 다룰 때 발행하는 NullPointerException(NPE) 바지
...
public class E_Optional {
    ...
    public static void main(String[] args) {
        // cf) NPE: null 참조된 객체에 접근할 때 발행하는 예외
        String name = null;
        ...
        // 3. Optional 값 확인 메서드
        // 1) isPresent(): 값이 존재하면 true, 존해하지 않을 경우 false
        // 2) isEmpty(): 값이 존재하면 false, 존해하지 않을 경우 true
        ...
        // 5. Optional 기본 값 처리
        //      >> 값을 확인하고 존재하면 반환, 존재하지 않으면 (빈 Optional) 경우 따라 반환 || 예외 발생
